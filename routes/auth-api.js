...
const RESET_TOKENS_PATH = path.join(__dirname, "../reset_tokens.json");
const RESET_RATE_LIMIT_PATH = path.join(__dirname, "../reset_rate_limit.json");
const LOGIN_RATE_LIMIT_PATH = path.join(__dirname, "../login_rate_limit.json");
const PROXY_REQUESTS_PATH = path.join(__dirname, "../proxy_requests.json");
const ADMIN_AUTH_LOG_PATH = path.join(__dirname, "../logs/admin-auth.json");
const CUSTOMER_AUTH_LOG_PATH = path.join(__dirname, "../logs/customer-auth.json");
